...
public class ProtobufLogicResolver
{
	 ...
	 * @return
	 */
	public static List<LogicInitiator> mapModelLogicInitiatorList(
			List<RblProto.RBLMessage.LogicInitiator> logicInitiators)
	{
	 ...
	 * @return
	 */
	public static ExecutionFrequency mapModelExecutionFrequency(
			RblProto.RBLMessage.ExecutionFrequency executionFrequency)
	{
	 ...
	 * @return
	 */
	public static List<RblProto.RBLMessage.LogicReceiver> mapProtobufLogicReceiverList(
			List<LogicReceiver> logicReceivers)
	{
